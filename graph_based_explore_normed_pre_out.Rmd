...
#level 1
level1.prout.mcns.pre.output <- cf_partners(cf_ids(malecns = mba.type.coalesced %>% 
...
level1.prout.mcns.output <- cf_partner_summary(cf_ids(malecns = mba.type.coalesced %>% 
                                             filter(flywire_type %in% cell_types)%>%
                                             pull(bodyid)), 
                                          partners = 'out', 
                                          threshold = synapse_threshold,
...
level2.prout.mcns.pre.output <- cf_partners(cf_ids(malecns= mba.type.coalesced %>% 
...
level2.prout.mcns.output <- cf_partner_summary(cf_ids(malecns= mba.type.coalesced %>% 
                                             filter(type %in% (level1.prout.mcns.output%>%
                                                                 pull(type.post)%>%
                                                                 unique()))%>%
                                             pull(bodyid)), 
...
level3.prout.mcns.pre.output <- cf_partners(cf_ids(malecns= mba.type.coalesced %>% 
...
level3.prout.mcns.output <- cf_partner_summary(cf_ids(malecns= mba.type.coalesced %>% 
                                             filter(type %in% (level2.prout.mcns.output%>%
                                                                 pull(type.post)%>%
                                                                 unique()))%>%
                                             pull(bodyid)), 
...
all.levels.prout.mcns.output <- rbind(level1.prout.mcns.output,level2.prout.mcns.output,level3.prout.mcns.output) 
...
target_cells <- c(V(g.prout.mcns)$name[grepl("P1_", V(g.prout.mcns)$name)], target_cells)
